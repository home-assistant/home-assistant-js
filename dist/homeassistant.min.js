!function(t){function n(r){if(e[r])return e[r].exports;var i=e[r]={exports:{},id:r,loaded:!1};return t[r].call(i.exports,i,i.exports,n),i.loaded=!0,i.exports}var e={};return n.m=t,n.c=e,n.p="",n(0)}([/*!******************************!*\
  ...
  \******************************/
function(t,n,e){"use strict";var r=e(/*! ./app_dispatcher */1);window.hass||(window.hass={callApi:e(/*! ./call_api */5),dispatcher:r,constants:e(/*! ./constants */2),util:e(/*! ./util */24),authActions:e(/*! ./actions/auth */25),componentActions:e(/*! ./actions/component */19),eventActions:e(/*! ./actions/event */20),serviceActions:e(/*! ./actions/service */21),stateActions:e(/*! ./actions/state */10),syncActions:e(/*! ./actions/sync */11),stateHistoryActions:e(/*! ./actions/state_history */26),streamActions:e(/*! ./actions/stream */22),authStore:e(/*! ./stores/auth */6),componentStore:e(/*! ./stores/component */13),eventStore:e(/*! ./stores/event */14),serviceStore:e(/*! ./stores/service */7),stateStore:e(/*! ./stores/state */16),syncStore:e(/*! ./stores/sync */18),stateHistoryStore:e(/*! ./stores/state_history */17),streamStore:e(/*! ./stores/stream */8),preferenceStore:e(/*! ./stores/preference */15),stateModel:e(/*! ./models/state */12),storeListenerMixIn:e(/*! ./mixins/store_listener */27)})},/*!*******************************!*\
  !*** ./src/app_dispatcher.js ***!
  \*******************************/
function(t,n,e){"use strict";var r=e(/*! flux */28).Dispatcher;t.exports=new r},/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
...
function(t,n,e){"use strict";var r=e(/*! lodash */3),i=e(/*! ../app_dispatcher */1),u=e(/*! ../constants */2),o=e(/*! ../stores/store */4),a=6e4,s=null,c={},f={},l={};r.assign(l,o.prototype,{isStale:function(t){var n=r.isUndefined(t)?s:c[t]||null;return null===n||(new Date).getTime()-n.getTime()>a},get:function(t){return f[t]||null},all:function(){return r.values(f)}}),l.dispatchToken=i.register(function(t){switch(t.actionType){case u.ACTION_NEW_STATE_HISTORY:r.forEach(t.stateHistory,function(t){if(0!==t.length){var n=t[0].entityId;f[n]=t,c[n]=new Date}}),t.isFetchAll&&(s=new Date),l.emitChange();break;case u.ACTION_LOG_OUT:s=null,c={},f={},l.emitChange()}}),t.exports=l},/*!****************************!*\
  !*** ./src/stores/sync.js ***!
  \****************************/
function(t,n,e){"use strict";var r=e(/*! lodash */3),i=e(/*! ../app_dispatcher */1),u=e(/*! ../constants */2),o=e(/*! ../stores/store */4),a=!1,s=[],c=function(t){return-1!==s.indexOf(t)},f=function(){return 4===s.length},l={};r.assign(l,o.prototype,{isFetching:function(){return!f()},initialLoadDone:function(t){var n=function(){return t.apply(this,arguments)};return n.toString=function(){return t.toString()},n}(function(){return a}),componentsLoaded:function(){return c(u.ACTION_NEW_LOADED_COMPONENTS)},eventsLoaded:function(){return c(u.ACTION_NEW_EVENTS)},servicesLoaded:function(){return c(u.ACTION_NEW_SERVICES)},statesLoaded:function(){return c(u.ACTION_NEW_STATES)}}),l.dispatchToken=i.register(function(t){switch(t.actionType){case u.ACTION_FETCH_ALL:s=[],l.emitChange();break;case u.ACTION_NEW_LOADED_COMPONENTS:case u.ACTION_NEW_EVENTS:case u.ACTION_NEW_SERVICES:case u.ACTION_NEW_STATES:c(t.actionType)||(s.push(t.actionType),a=a||f(),l.emitChange());break;case u.ACTION_LOG_OUT:a=!1,s=[],l.emitChange()}}),t.exports=l},/*!**********************************!*\
...
function(t,n,e){"use strict";var r=e(/*! ../call_api */5),i=e(/*! ../app_dispatcher */1),u=e(/*! ../constants */2),o=e(/*! ./notification */9),a=e(/*! ./state */10);t.exports={newServices:function(t){i.dispatch({actionType:u.ACTION_NEW_SERVICES,services:t})},callTurnOn:function(t){return this.callService("homeassistant","turn_on",{entity_id:t})},callTurnOff:function(t){return this.callService("homeassistant","turn_off",{entity_id:t})},callService:function(t,n,e){return e=e||{},r("POST","services/"+t+"/"+n,e).then(function(r){o.notify("turn_on"==n&&e.entity_id?"Turned on "+e.entity_id+".":"turn_off"==n&&e.entity_id?"Turned off "+e.entity_id+".":"Service "+t+"/"+n+" called."),r.length>0&&a.newStates(r)})},fetchAll:function(){return r("GET","services").then(this.newServices.bind(this))}}},/*!*******************************!*\
  ...
  \*******************************/
function(t,n,e){"use strict";var r=e(/*! ../app_dispatcher */1),i=e(/*! ../constants */2),u=e(/*! ./sync */11),o=!1,a=null,s=null,c=null,f=null,l=3e3,h=1e3,p=function(){var t=function(){if(o&&console.log("check state, ",a.readyState,c),a.readyState===EventSource.CLOSED){var t=(new Date).getTime();(null===c||t-c>l)&&(o&&console.log("fixing state, now:",t),g.start(s))}};f=setInterval(t,h)},v=function(){a.close(),a=null,s=null,c=null,clearInterval(f),f=null},g={isSupported:function(){return!!EventSource},start:function(t){if(null!==a){if(a.readyState===EventSource.OPEN)return;v()}var n="/api/stream";t&&(n+="?api_password="+t),a=new EventSource(n),s=t,p(),a.addEventListener("message",function(t){r.dispatch({actionType:i.ACTION_REMOTE_EVENT_RECEIVED,event:JSON.parse(t.data)})},!1),a.addEventListener("open",function(){r.dispatch({actionType:i.ACTION_STREAM_START}),u.stopSync(),u.fetchAll()},!1),a.addEventListener("error",function(){c=(new Date).getTime(),a.readyState==EventSource.CLOSED?g.stop():r.dispatch({actionType:i.ACTION_STREAM_ERROR})},!1)},stop:function(){v(),r.dispatch({actionType:i.ACTION_STREAM_STOP}),u.sync()},debug:function(t){var n=function(){return t.apply(this,arguments)};return n.toString=function(){return t.toString()},n}(function(){window._stream_source=a,o=!0})};t.exports=g},/*!************************************!*\
...
function(t,n,e){"use strict";var r=e(/*! lodash */3),i=e(/*! ../app_dispatcher */1),u=e(/*! ../constants */2),o=e(/*! ../stores/store */4),a=[],s={};r.assign(s,o.prototype,{hasNewNotifications:function(t){return t=t||-1,t+1<a.length},getLastNotification:function(){return a[a.length-1]}}),s.dispatchToken=i.register(function(t){switch(t.actionType){case u.ACTION_NEW_NOTIFICATION:a.push({id:a.length,message:t.message}),s.emitChange();break;case u.ACTION_LOG_OUT:a=[],s.emitChange()}}),t.exports=s},/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
function(t,n){"use strict";function e(t){var n=t.split(" "),e=n[0].split(":"),r=n[1].split("-");return new Date(r[2],parseInt(r[1])-1,r[0],e[0],e[1],e[2])}n.parseDateTime=e,Object.defineProperty(n,"__esModule",{value:!0})},/*!*****************************!*\
  !*** ./src/actions/auth.js ***!
  \*****************************/
function(t,n,e){"use strict";var r=e(/*! ../call_api */5),i=e(/*! ../app_dispatcher */1),u=e(/*! ../constants */2),o=e(/*! ../actions/sync */11),a=e(/*! ../actions/stream */22);t.exports={validate:function(t,n){n=n&&a.isSupported(),i.dispatch({actionType:u.ACTION_VALIDATING_AUTH_TOKEN}),r("GET","",!1,{auth:t}).then(function(){i.dispatch({actionType:u.ACTION_VALID_AUTH_TOKEN,authToken:t}),n?a.start(t):o.sync()},function(t){i.dispatch({actionType:u.ACTION_INVALID_AUTH_TOKEN,message:t.message})})},logOut:function(){i.dispatch({actionType:u.ACTION_LOG_OUT})}}},/*!**************************************!*\
...
function(t,n,e){"use strict";var r=e(/*! lodash */3),i=e(/*! ../call_api */5),u=e(/*! ../app_dispatcher */1),o=e(/*! ../constants */2),a=e(/*! ../models/state */12);t.exports={newStateHistory:function(t,n){u.dispatch({actionType:o.ACTION_NEW_STATE_HISTORY,stateHistory:r.map(n,function(t){return r.map(t,a.fromJSON)}),isFetchAll:t})},fetchAll:function(){i("GET","history/period").then(this.newStateHistory.bind(this,!0))},fetch:function(t){i("GET","history/period?filter_entity_id="+t).then(this.newStateHistory.bind(this,!1))}}},/*!**************************************!*\
  ...
  \**************************************/
function(t,n,e){"use strict";function r(t){var n=[];u.forEach(function(e,r){var i=e+"StoreChanged";if(this[i]){var u=a(r),o=this[i].bind(this,u);u.addChangeListener(o),n.push({store:u,listener:o}),t&&o()}}.bind(this)),this._storeListeners=n}function i(){this._storeListeners.forEach(function(t){var n=t.store,e=t.listener;n.removeChangeListener(e)})}n.listenToStores=r,n.stopListeningToStores=i;var u=["auth","component","event","service","state","stateHistory","stream","sync","notification"],o=u.map(function(t){return t.replace(/([A-Z])/g,function(t){return"_"+t.toLowerCase()})}),a=function(t){/*! ../stores */
return e(33)("./"+o[t])};Object.defineProperty(n,"__esModule",{value:!0})},/*!*************************!*\
  !*** ./~/flux/index.js ***!
  \*************************/
